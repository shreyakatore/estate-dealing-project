...
<body>
        ...
        <section class="post_property  mt-4">
            <div class="container  post_property">
                        ...
                        <form class="d-flex mt-3 flex-column align-items-center">
                            ...
                            <div class="left-option maxWidth" style="margin-top: 5%;">
                                <div class="Property-available-for">
                                    <h6 class="mb-3"><label for="property-option "
                                            style="text-align:center; font-weight:bold;">City:</label></h6>
                                ...
                                <div class="Property-available-for my-5">
                                    <h5 class="my-4 text-bold"><strong><label
                                                style="text-align:center; font-weight:bold;">Property Available
                                                For</label> </strong></h5>
                                ...
                                <div id="sellDiv" class="Property-available-for my-5" style="display: none;">
                                    <div class="property-form-group">
                                        <h5><label for="sell-residental-flat/apartment"
                                                style="text-align:center;">Residential</label></h5>
                                        <select id="sell-flat-selection" name="flat[]" onchange="logSelectedValue()">
                                    ...
                                    <div class="property-form-group">
                                        <h5><label for="sell-residental-flat/apartment"
                                                style="text-align:center;">Commercial </label></h5>
                                ...
                                <div id="rentDiv" class="Property-available-for my-5 " style="display: none;">
                                    <!-- Content specific to Renting/Leasing Property will go here -->
                                    <div class="property-form-group">
                                        <h5><label for="sell-residental-flat/apartment" style="text-align:center;">
                                                Residential </label>
                                        </h5>
                                        <select id="flat-apartment" name="flat[]">
                                ...
                                <div id="pgDiv" class="Property-available-for my-5" style="display: none;">
                                    ...
                                    <div class="property-form-group">
                                        <h5><label for="sell-residental-flat/apartment"
                                                style="text-align:center;">Residential </label>
                                        </h5>
                                        <select id="flat-apartment" name="flat[]">
                                            <option>Flat/Apartment</option>
                ...
                <div class="col-lg-8 col-md-6 col-12 propertydiv d-none" id="propertyDetails"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group">
                                            <label for="plot-area">Area of plot (in sqft feet or sq mtr)</label>
                                            <input type="text" id="plot-area" name="plot-area"
                                                style="padding-right: 4rem;">
                                        </div>

                                        <div class="property-form-group">
                                            <label for="BHK">Plot length (in feet or mtr)</label>
                                            <input type="text" id="Built-Area" style="padding-right: 4rem;"> </input>
                                        </div>
                                        <div class="property-form-group">
                                            <label for="BHK">Plot Width (in feet or mtr)</label>
                                            <input type="text" id="Built-Area" style="padding-right: 4rem;"> </input>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="right-option  mx-2" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group authority-chips">
                                            <label for="authority">Approval authority</label>
                                            <input type="radio" id="lda-1" name="authority-1" value="LDA">
                                            <label class="chip" for="lda-1">LDA</label>

                                            <input type="radio" id="awas-vikas-1" name="authority-1" value="Awas Vikas">
                                            <label class="chip" for="awas-vikas-1">Awas Vikas</label>
                                        </div>
                    ...
                    <form id="flat-apartment-1" class="flat-form" style="display:none;">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group">
                                            ...
                                            <div class="rooms-chips" id="rooms-chips-container">
                                                <div class="chip" data-value="Pooja-Room"> Pooja Room</div>
                                                <div class="chip" data-value="Store-Room"> Store Room</div>
                                                <div class="chip" data-value="Study-Room"> Study Room</div>
                                                <div class="chip" data-value="Servant-Room"> Servant Room</div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group ">
                                            <label for="property-Possession">Unit No </label>
                                            <input type="text" id="unitno" style="padding-right: 4rem;"> </input>
                                            <input type="checkbox" id="keep-private-checkbox"
                                                style="margin-left:3%;  margin-top:2%;">(Keep it private)
                                        </div>
                                        ...
                                        <!-- proper  -->
                                        <div class="property-form-group furnishing">
                                            <label for="property-Furnishing">Furnishing</label>
                                            <div class="chip-switcher" id="property-Furnishing">
                                                <div class="chip furnishing-chip" data-value="fully-furnished">Fully
                                                    furnished</div>
                                                <div class="chip furnishing-chip" data-value="semi-furnished">
                                                    Semi-furnished
                                                </div>
                                                <div class="chip furnishing-chip" data-value="unfurnished">Unfurnished
                                                </div>
                                            </div>
                                        </div>

                                        <div class="property-form-group furnishing-1" id="fully-furnished-items"
                                            style="display: none;">
                                            <label for="property-FullyFurnished">Fully furnished</label>
                                            <div class="checkbox-container">
                                                <label><input type="checkbox" name="fullyFurnished" value="sofa">
                                                    sofa</label>
                                                <label><input type="checkbox" name="fullyFurnished"
                                                        value="Washing Machine">
                                                    Washing Machine</label>
                                                <label><input type="checkbox" name="fullyFurnished"> Stove</label>
                                                <label><input type="checkbox" name="fullyFurnished" value="tv">
                                                    Fridge</label>
                                                <label><input type="checkbox" name="fullyFurnished" value="beds">
                                                    Microwave </label>
                                                <label><input type="checkbox" name="fullyFurnished" value="wardrobe">
                                                    Modular Kitchen</label>
                                                <label><input type="checkbox" name="fullyFurnished" value="geyser">
                                                    Chimney</label>
                                                <label><input type="checkbox" name="fullyFurnished" value="geyser">
                                                    Curtains</label>
                                                <label><input type="checkbox" name="fullyFurnished" value="geyser">
                                            ...
                                            <div class="checkbox-container">
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished8">Light</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished8')">-</button>
                                                    <input type="number" id="fullyFurnished8" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished8')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished9"> Fans</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished9')">-</button>
                                                    <input type="number" id="fullyFurnished9" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished9')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished10"> AC</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished10')">-</button>
                                                    <input type="number" id="fullyFurnished10" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished10')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished11"> TV</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished11')">-</button>
                                                    <input type="number" id="fullyFurnished11" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished11')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished12">Beds</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished12')">-</button>
                                                    <input type="number" id="fullyFurnished12" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished12')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished13"> Water Purifier</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished13')">-</button>
                                                    <input type="number" id="fullyFurnished13" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished13')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished14"> Wardrobe</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished14')">-</button>
                                                    <input type="number" id="fullyFurnished14" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished14')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="fullyFurnished15">Geyser</label>
                                                    <button onclick="decreaseQuantity('fullyFurnished15')">-</button>
                                                    <input type="number" id="fullyFurnished15" name="fullyFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('fullyFurnished15')">+</button>
                                                </div>

                                            </div>
                                        </div>

                                        <div class="property-form-group furnishing-1" id="semi-furnished-items"
                                            style="display: none;">
                                            <label for="property-SemiFurnished">Semi furnished</label>
                                            <div class="checkbox-container">
                                                <label><input type="checkbox" name="semiFurnished" value="Sofa">
                                                    Sofa </label>
                                                <label><input type="checkbox" name="semiFurnished"
                                                        value="Washing Machine">
                                                    Washing Machine </label>
                                                <label><input type="checkbox" name="semiFurnished" value="Stove">Stove
                                                </label>
                                                <label><input type="checkbox" name="semiFurnished"
                                                        value="Fridge">Fridge</label>
                                                <label><input type="checkbox" name="semiFurnished" value="beds">Water
                                                    Purifier </label>
                                                <label><input type="checkbox" name="semiFurnished" value="wardrobe">
                                                    Microwave </label>
                                                <label><input type="checkbox" name="semiFurnished"
                                                        value="Modular Kitchen">
                                                    Modular Kitchen </label>
                                                <label><input type="checkbox" name="semiFurnished" value="Chimney">
                                                </label>
                                                <label><input type="checkbox" name="semiFurnished" value="Curtains">
                                                    Curtains</label>
                                                <label><input type="checkbox" name="semiFurnished"
                                                        value="Dinning Table">
                                                    Dinning Table</label>
                                                <label><input type="checkbox" name="semiFurnished" value="Exhaust Fan">
                                                    Exhaust Fan</label>
                                            </div>
                                            <div class="checkbox-container">
                                                <div class="quantity-container">
                                                    <label for="semiFurnished8">Light</label>
                                                    <button onclick="decreaseQuantity('semiFurnished8')">-</button>
                                                    <input type="number" id="semiFurnished8" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished8')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="semiFurnished9"> Fans</label>
                                                    <button onclick="decreaseQuantity('semiFurnished9')">-</button>
                                                    <input type="number" id="semiFurnished9" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished9')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="semiFurnished10">AC</label>
                                                    <button onclick="decreaseQuantity('semiFurnished10')">-</button>
                                                    <input type="number" id="semiFurnished10" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished10')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="semiFurnished11">TV</label>
                                                    <button onclick="decreaseQuantity('semiFurnished11')">-</button>
                                                    <input type="number" id="semiFurnished11" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished11')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="semiFurnished12"> Beds </label>
                                                    <button onclick="decreaseQuantity('semiFurnished12')">-</button>
                                                    <input type="number" id="semiFurnished12" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished12')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="semiFurnished13"> Wardrobe</label>
                                                    <button onclick="decreaseQuantity('semiFurnished13')">-</button>
                                                    <input type="number" id="semiFurnished13" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished13')">+</button>
                                                </div>
                                                <div class="quantity-container">
                                                    <label for="semiFurnished14"> Geyser</label>
                                                    <button onclick="decreaseQuantity('semiFurnished14')">-</button>
                                                    <input type="number" id="semiFurnished14" name="semiFurnished"
                                                        value="0" readonly>
                                                    <button onclick="increaseQuantity('semiFurnished14')">+</button>
                                                </div>

                                            </div>
                                        </div>

                                        <div class="property-form-group furnishing-1" id="unfurnished-items"
                                            style="display: none;">
                                            <label for="property-Unfurnished">Unfurnished</label>
                                            <!-- Add any specific unfurnished items here if needed -->
                                        </div>
                                        ...
                                        <div class="property-form-group possessiondiv">
                                            <label for="flat-property-PossessionStatus">Possession Status</label>
                                            <div class="possession-container">
                                                <div class="possession-chips flat-possession-chips">
                                                    <div class="chip" data-value="ready-to-move">Ready To Move</div>
                                                    <div class="chip" data-value="under-construction">Under Construction
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="property-form-group" id="flat-property-age-group"
                                            style="display: none;">
                                            <label for="flat-property-age">Property Age</label>
                                            <select id="flat-property-age">
                                                <option value="flat-property-age1">Under Construction</option>
                                                <option value="flat-property-age2">Less than a Year</option>
                                                <option value="flat-property-age3">1 to 3 years</option>
                                                <option value="flat-property-age4">3 to 5 years</option>
                                                <option value="flat-property-age5">5 to 10 years</option>
                                                <option value="flat-property-age6">More than 10 years</option>
                                            </select>
                                        </div>
                                        <div class="property-form-group" id="flat-possession-by-group"
                                            style="display: none;">
                                            <label for="flat-property-Possession">Possession By</label>
                                            <select id="flat-property-Possession">
                                                <option value="flat-property-Possession1">Expected by</option>
                                                <option value="flat-property-Possession2">Within 3 Months</option>
                                                <option value="flat-property-Possession3">Within 6 Months</option>
                                                <option value="flat-property-Possession4">By 2024</option>
                                                <option value="flat-property-Possession5">By 2025</option>
                                                <option value="flat-property-Possession6">By 2026</option>
                                                <option value="flat-property-Possession7">By 2027</option>
                                                <option value="flat-property-Possession8">By 2028</option>
                                                <option value="flat-property-Possession9">By 2029</option>
                                                <option value="flat-property-Possession10">By 2030</option>
                                                <option value="flat-property-Possession11">By 2031</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="property-form-group authority-chips">
                                            <label for="authority">Approval authority</label>
                                            <input type="radio" id="lda-2" name="authority-2" value="LDA">
                                            <label class="chip" for="lda-2">LDA</label>

                                            <input type="radio" id="awas-vikas-2" name="authority-2" value="Awas Vikas">
                                            <label class="chip" for="awas-vikas-2">Awas Vikas</label>
                                        </div>
                    ...
                    <form id="villa-1" class="villa" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group">
                                            <label for="plot-no">Other rooms</label>
                                            <div class="chips" id="rooms-chips-2">
                                                <div class="rooms-chips" id="rooms-chips-container-2">
                                                    <div class="chip" data-value="rooms1">Pooja Room</div>
                                                    <div class="chip" data-value="rooms2">Store Room</div>
                                                    <div class="chip" data-value="rooms3">Study Room</div>
                                                    <div class="chip" data-value="rooms4">Servant Room</div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group possessiondiv">
                                            <label for="villa-property-PossessionStatus">Possession Status</label>
                                            <div class="possession-container">
                                                <div class="possession-chips villa-possession-chips">
                                                    <div class="chip" data-value="ready-to-move">Ready To Move</div>
                                                    <div class="chip" data-value="under-construction">Under Construction
                                                    </div>
                                                </div>
                                        ...
                                        <div class="property-form-group" id="villa-property-age-group"
                                            style="display: none;">
                                            <label for="villa-property-age">Property Age</label>
                                            <select id="villa-property-age">
                                                <option value="villa-property-age1">Under Construction</option>
                                                <option value="villa-property-age2">Less than a Year</option>
                                                <option value="villa-property-age3">1 to 3 years</option>
                                                <option value="villa-property-age4">3 to 5 years</option>
                                                <option value="villa-property-age5">5 to 10 years</option>
                                                <option value="villa-property-age6">More than 10 years</option>
                                            </select>
                                        </div>
                                        <div class="property-form-group" id="villa-possession-by-group"
                                            style="display: none;">
                                            <label for="villa-property-Possession">Possession By</label>
                                            <select id="villa-property-Possession">
                                                <option value="villa-property-Possession1">Expected by</option>
                                                <option value="villa-property-Possession2">Within 3 Months</option>
                                                <option value="villa-property-Possession3">Within 6 Months</option>
                                                <option value="villa-property-Possession4">By 2024</option>
                                                <option value="villa-property-Possession5">By 2025</option>
                                                <option value="villa-property-Possession6">By 2026</option>
                                                <option value="villa-property-Possession7">By 2027</option>
                                                <option value="villa-property-Possession8">By 2028</option>
                                                <option value="villa-property-Possession9">By 2029</option>
                                                <option value="villa-property-Possession10">By 2030</option>
                                                <option value="villa-property-Possession11">By 2031</option>
                                            </select>
                                        </div>

                                        <div class="property-form-group">
                                            <label for="brokrage">Do you have more similar units/properties
                                                available?</label>
                                            <div class="d-flex" style="column-gap: 18px;">
                                        ...
                                        <div class="property-form-group authority-chips">
                                            <label for="authority">Approval authority</label>
                                            <input type="radio" id="lda-3" name="authority-3" value="LDA">
                                            <label class="chip" for="lda-3">LDA</label>

                                            <input type="radio" id="awas-vikas-3" name="authority-3" value="Awas Vikas">
                                            <label class="chip" for="awas-vikas-3">Awas Vikas</label>
                                        </div>

                                        <div class="property-form-group">
                                            <label for="description-villa-text">Property Description</label>
                                            <textarea id="description-villa-text"
                                                style="padding-right: 4rem; border: 2px solid #ccc; width: 100%; height: 100%;"></textarea>
                                        </div>
                    ...
                    <form id="builder-1" class="builder" style="display:none;">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group">
                                            <label for="plot-no">Other rooms</label>
                                            <div class="rooms-chips" id="rooms-chips-container-3">
                                                <div class="chip" data-value="rooms1">Pooja Room</div>
                                                <div class="chip" data-value="rooms2">Store Room</div>
                                                <div class="chip" data-value="rooms3">Study Room</div>
                                                <div class="chip" data-value="rooms4">Servant Room</div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="left-option" style="margin-top: 10%;">
                                        ...
                                        <div class="property-form-group possessiondiv">
                                            ...
                                            <div class="possession-container">
                                                <div class="possession-chips builder-possession-chips">
                                                    <div class="chip" data-value="ready-to-move">Ready To Move</div>
                                                    <div class="chip" data-value="under-construction">Under Construction
                                                    </div>
                                                </div>
                                        ...
                                        <div class="property-form-group hidden" id="builder-property-age-group">
                                            <label for="builder-property-age">Property Age</label>
                                            <select id="builder-property-age">
                                                <option value="builder-property-age1">Under Construction</option>
                                                <option value="builder-property-age2">Less than a Year</option>
                                                <option value="builder-property-age3">1 to 3 years</option>
                                                <option value="builder-property-age4">3 to 5 years</option>
                                                <option value="builder-property-age5">5 to 10 years</option>
                                                <option value="builder-property-age6">More than 10 years</option>
                                            </select>
                                        </div>

                                        <div class="property-form-group hidden" id="builder-possession-by-group">
                                            <label for="builder-property-Possession">Possession By</label>
                                            <select id="builder-property-Possession">
                                                <option value="builder-property-Possession1">Expected by</option>
                                                <option value="builder-property-Possession2">Within 3 Months</option>
                                                <option value="builder-property-Possession3">Within 6 Months</option>
                                                <option value="builder-property-Possession4">By 2024</option>
                                                <option value="builder-property-Possession5">By 2025</option>
                                                <option value="builder-property-Possession6">By 2026</option>
                                                <option value="builder-property-Possession7">By 2027</option>
                                                <option value="builder-property-Possession8">By 2028</option>
                                                <option value="builder-property-Possession9">By 2029</option>
                                                <option value="builder-property-Possession10">By 2030</option>
                                                <option value="builder-property-Possession11">By 2031</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="furnishing-content" class="furnituring-box furnituring-box1">
        <div class="property-form-group villa-furnishing furnishing">
            <label for="property-Furnishing">Furnishing</label>
            <div class="chip-switcher" id="property-Furnishing">
                <div class="chip furnishing-chip" data-value="fully-furnished">Fully furnished</div>
                <div class="chip furnishing-chip" data-value="semi-furnished">Semi-furnished</div>
                <div class="chip furnishing-chip" data-value="unfurnished">Unfurnished</div>
            </div>
        </div>

        <div id="furnishingPopup" class="popup-modal">
            <div class="popup-modal-content">
                <span class="close">&times;</span>
                <div id="popupContent" class="popup-content">
                    <div class="property-form-group villa-furnishing" id="fully-furnished-items" style="display: none;">
                        <label for="property-FullyFurnished">Fully furnished</label>
                        <div class="checkbox-container">
                            <label><input type="checkbox" name="fullyFurnished" value="sofa"> Sofa</label>
                            <label><input type="checkbox" name="fullyFurnished" value="washing-machine">Washing Machine</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Stove"> Stove</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Fridge"> Fridge</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Water-Purifier"> Water Purifier</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Microwave"> Microwave</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Modular-Kitchen"> Modular Kitchen</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Chimney"> Chimney</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Curtains"> Curtains</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Dinning-Table"> Dinning Table</label>
                            <label><input type="checkbox" name="fullyFurnished" value="Exhaust-Fan"> Exhaust Fan</label>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished8">Light</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished8')">-</button>
                            <input type="number" id="fullyFurnished8" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished8')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished9">Fans</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished9')">-</button>
                            <input type="number" id="fullyFurnished9" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished9')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished10">AC</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished10')">-</button>
                            <input type="number" id="fullyFurnished10" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished10')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished11">TV</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished11')">-</button>
                            <input type="number" id="fullyFurnished11" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished11')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished12">Beds</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished12')">-</button>
                            <input type="number" id="fullyFurnished12" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished12')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished13">Wardrobe</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished13')">-</button>
                            <input type="number" id="fullyFurnished13" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished13')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="fullyFurnished14">Geyser</label>
                            <button onclick="decreaseQuantity(event, 'fullyFurnished14')">-</button>
                            <input type="number" id="fullyFurnished14" name="fullyFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'fullyFurnished14')">+</button>
                        </div>
                    </div>

                    <div class="property-form-group villa-furnishing" id="semi-furnished-items" style="display: none;">
                        <label for="property-SemiFurnished">Semi furnished</label>
                        <div class="checkbox-container">
                            <label><input type="checkbox" name="semiFurnished" value="sofa">Sofa</label>
                            <label><input type="checkbox" name="semiFurnished" value="fans">Fans</label>
                            <label><input type="checkbox" name="semiFurnished" value="ac">AC</label>
                            <label><input type="checkbox" name="semiFurnished" value="tv">TV</label>
                            <label><input type="checkbox" name="semiFurnished" value="beds">Beds</label>
                            <label><input type="checkbox" name="semiFurnished" value="wardrobe">Wardrobe</label>
                            <label><input type="checkbox" name="semiFurnished" value="geyser">Geyser</label>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished8">Light</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished8')">-</button>
                            <input type="number" id="semiFurnished8" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished8')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished9">Fans</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished9')">-</button>
                            <input type="number" id="semiFurnished9" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished9')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished10">AC</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished10')">-</button>
                            <input type="number" id="semiFurnished10" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished10')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished11">TV</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished11')">-</button>
                            <input type="number" id="semiFurnished11" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished11')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished12">Beds</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished12')">-</button>
                            <input type="number" id="semiFurnished12" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished12')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished13">Wardrobe</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished13')">-</button>
                            <input type="number" id="semiFurnished13" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished13')">+</button>
                        </div>
                        <div class="quantity-container">
                            <label for="semiFurnished14">Geyser</label>
                            <button onclick="decreaseQuantity(event, 'semiFurnished14')">-</button>
                            <input type="number" id="semiFurnished14" name="semiFurnished" value="0" readonly>
                            <button onclick="increaseQuantity(event, 'semiFurnished14')">+</button>
                        </div>
                    </div>

                    <div class="property-form-group villa-furnishing" id="unfurnished-items" style="display: none;">
                        <label for="property-Unfurnished">Unfurnished</label>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class=" authority-chips">
                                            <label for="authority">Approval authority</label>
                                            <input type="radio" id="lda-4" name="authority" value="LDA">
                                            <label class="chip" for="lda-4">LDA</label>

                                            <input type="radio" id="awas-vikas-4" name="authority" value="Awas Vikas">
                                            <label class="chip" for="awas-vikas-4">Awas Vikas</label>
                                        </div>

                                        <div class="property-form-group">
                                            <label for="description-Builder-text">Property Description</label>
                                            <textarea id="description-Builder-text"
                                                style="padding-right: 4rem; border: 2px solid #ccc; width: 100%; height: 100%;"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-8 col-md-6 col-12 properyInputInfo d-none" id="amenitiesDetails"
                    ...
                    <form class="chip-box" id="flat-apartment-2" style="display:none;">
                    ...
                    <form class="chip-box" id="plot-land-2" style="display:none;">
                        <div class="amenties-second chips-amenties">
                            <h4 class=" mt-4 mb-2">#View </h4><br>
                            <div class="chips-container" id="chipsContainer">
                                <div class="chip" data-value="Golf Course"> Golf Course</div>
                ...
                <div class="col-lg-8 col-md-6 col-12  d-none price-details" id="pricingDetails"
                    ...
                    <form class=" mt-3 " id="plot-land-3" style="display:none;">
                        <div class="d-flex">
                            ...
                            <div class="right-option  mx-2" style="margin-top: 10%;">
                                ...
                                <div
                                    class=" property-form-group property-form-group-price-maintenance maintainance-checkbox">
                                    <label for="maintance-label" style="line-height:30px;"> Maintenance</label>
                                    <div class="d-flex">
                                        <input type="checkbox" id="maintenance-included-plot">
                                        <label for="maintenance-included-plot">Maintenance included</label>
                                    </div>
                                </div>

                                <div class="property-form-group-price-maintenance" id="maintenance-amount-group-plot">
                                    <label for="maintenance-amount" style="color:grey">Maintenance amount (per
                                        month)</label>
                    ...
                    <form id="flat-apartment-3" style="display:none;">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="property-form-group">
                                ...
                                <div class="property-form-group ">
                                    ...
                                    <label for="BHK">Booking / Token Amount:</label>
                                    <div class="check-box d-flex mt-3" style="column-gap: 5px;">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <div class="property-form-group-price-mentainance maintainace-checkbox">
                                    <label for="maintance-label"> Maintenance</label>
                                    <div class="d-flex">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function logSelectedValue() {
                var selectElement = document.getElementById('sell-flat-selection');
    ...
    <script>
        ...
        // Add click event listener to room chips
        var allRoomChipsContainers = document.querySelectorAll('.rooms-chips');
        allRoomChipsContainers.forEach(function (container) {
            var roomChips = container.querySelectorAll('.chip');
